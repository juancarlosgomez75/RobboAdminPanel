<div>
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item "><a href="{{route("inventario.index")}}" class="text-secondary">Productos</a></li>
            <li class="breadcrumb-item "><a href="{{route("inventario.viewedit",$inventory->product_info->id)}}" class="text-secondary">Producto</a></li>
