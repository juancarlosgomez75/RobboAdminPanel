    ...
    <div class="row w-100 justify-content-center">
        <div class="col-12 col-md-6 col-lg-6">
            <div class="card border p-5 shadow-lg text-center mx-auto custom-card">
                <div class="card-body">
                    <img src="<?php echo e(asset('img/Logo.png')); ?>" class="img-fluid d-block mx-auto" alt="Imagen" width="300" style="padding: 8px; margin-bottom: 2rem; margin-top: 1rem;">
                    ...
                    <div class="mt-3">
                        ...
                        <br>
                        <small><?php echo e($prueba); ?></small>
                    </div>
                </div>
            </div>
        </div>
    </div>
</div><?php /**PATH C:\xampp\htdocs\RobboAdminPanel\panel\resources\views\livewire\login.blade.php ENDPATH**/ ?>