<div>
    <!--[if BLOCK]><![endif]--><?php if($alerta): ?>
        <!--[if BLOCK]><![endif]--><?php if($alerta_sucess!=""): ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            ...
                            <select class="form-select" id="tiponame" wire:model="estudioid">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if(!empty($information)): ?>
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $information; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
