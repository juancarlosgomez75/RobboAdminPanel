        ...
        <table border="0" cellpadding="0" cellspacing="0" width="600" style="background-color:#ffffff; border-radius:10px; border-left:1px solid #ddd; border-right:1px solid #ddd;">
          ...
          <tr>
            <td bgcolor="#ca4a4c" style="padding:50px 20px 20px 20px; text-align:center;">
                ...
                <h1 style="color:#ffffff; font-size:30px; margin:10px 0 5px; text-align:center;"><?php echo e($reason); ?></h1>
                <p style="color:#ffffff; font-size:16px; margin:0; text-align:center;"><?php echo e(ucfirst($informacion["FechaInicio"] )); ?> - <?php echo e(ucfirst($informacion["FechaFin"])); ?></p>
              </td>              
          </tr>
          ...
          <tr>
            <td style="padding:20px;">
              <p style="font-size:22px; margin-top:0;">Hola, <b style="color:#ca4a4c;"><?php echo e($informacion["Contact"]); ?></b></p>

              <p style="font-size:16px;">En Robbocock queremos que siempre tengas a tu alcance la información necesaria para tomar decisiones estratégicas sobre tu operación en <b style="color:#ca4a4c;"><?php echo e($informacion["StudyName"]); ?></b>, por ello, te compartimos el reporte de ventas generadas por tus artistas mediante el uso de nuestros dispositivos.</p>
...
<?php /**PATH C:\xampp\htdocs\RobboAdminPanel\panel\resources\views/emails/reporte.blade.php ENDPATH**/ ?>