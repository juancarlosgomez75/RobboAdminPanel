                        ...
                        <tbody>
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <!--[if BLOCK]><![endif]--><?php if($account->activo ): ?>
                                    ...
                                    <td>
                                        <!--[if BLOCK]><![endif]--><?php if(auth()->user()->id == $account->id): ?>
                                        Tu cuenta
                                        <?php elseif(auth()->user()->rank <= $account->rank): ?>
                                        Sin acciones
                                        <?php else: ?>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select" wire:model="rank" required>
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $rangos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rank): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
