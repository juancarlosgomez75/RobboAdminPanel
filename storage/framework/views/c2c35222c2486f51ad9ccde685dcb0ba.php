<div>
    ...
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item "><a href="<?php echo e(route("manager.ver",$manageractual)); ?>" class="text-secondary">Manager</a></li>
                    ...
                    <table class="table">
                        ...
                        <tbody class="align-middle">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="form-select" wire:model="paginas.<?php echo e($indice); ?>.NickPage" <?php if(!$editing): ?> disabled <?php endif; ?>>
