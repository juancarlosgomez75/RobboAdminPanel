                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($toStudy=="1"): ?>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($studyFind=="1"): ?>
                                <div class="col-md-4 mb-3">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($activeBasic): ?>
                        ...
                        <tbody>
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $listProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$pd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" min="1" class="form-control" wire:model="listProducts.<?php echo e($index); ?>.amount" >
                                    </td>
                                    <td>
