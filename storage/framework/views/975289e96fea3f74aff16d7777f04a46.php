            ...
            <div class="row">
                ...
                <div class="col-md-12 pt-3">
                    ...
                    <table class="table text-center" >
                        ...
                        <tbody>
                            <!--[if BLOCK]><![endif]--><?php if(!empty($listProducts)): ?>
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $listProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$pd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php else: ?>
                                        <input class="form-control form-control-sm " type="text" wire:model="listProducts.<?php echo e($index); ?>.name" >
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        
                                    </td>
                                    <td>
                                        <input type="number" min="1" class="form-control form-control-sm" wire:model="listProducts.<?php echo e($index); ?>.amount" >
                                    </td>
                                    <td>
                ...
                <div class="col-md-12">
                    <div class="d-flex justify-content-center align-items-center gap-3">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if(!$addingProduct): ?>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($result->inventory->stock_available); ?></td>
                                        <td class="d-grid">
                                            <a class="btn btn-outline-primary btn-sm" wire:click="addProduct(<?php echo e($index); ?>)">Añadir</a>
                                        </td>
                                    </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
...
</div><?php /**PATH C:\xampp\htdocs\RobboAdminPanel\panel\resources\views/livewire/inventario/request.blade.php ENDPATH**/ ?>