<div>
    <style>
        ...
        .progressbar li::after {
            ...
            position: absolute;
            top: 25px;
            width: <?php echo e($orden->type == 'collection' ? '13vw' : '14.2vw'); ?>; /* Ajusta el tamaño de la línea */
    ...
    <div class="card shadow-custom">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-12 pt-4">
                    <ul class="progressbar <?php if($orden->status=="canceled"): ?> cancelled <?php endif; ?>">
                        ...
                        <li <?php if($orden->status=="created"): ?> class="current" <?php endif; ?>>
                            ...
                            <span>
                                <!--[if BLOCK]><![endif]--><?php if($orden->status=="created"): ?>
                                Preparando
                                <?php else: ?>
                                Preparado
                        ...
                        <li <?php if($orden->status=="prepared"): ?> class="current" <?php endif; ?>>
                            ...
                            <span>
                                <!--[if BLOCK]><![endif]--><?php if($orden->status=="prepared"): ?>
                                Esperando guía
                        ...
                        <li <?php if($orden->status=="waiting"): ?> class="current" <?php endif; ?>>
                            ...
                            <span>
                                <!--[if BLOCK]><![endif]--><?php if($orden->status=="waiting"): ?>
                                Enviando
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($orden->type=="collection"): ?>
                        <li <?php if($orden->status=="sended"): ?> class="current" <?php endif; ?>>
                            <div class="icon-circle">
                                <i class="fa-brands fa-get-pocket"></i>
                            </div>
                            <span>
                                <!--[if BLOCK]><![endif]--><?php if($orden->status=="sended"): ?>
                                Esperando entrega
                                <?php elseif($orden->status=="collected"): ?>
                                Enviado
                                <?php else: ?>
                                Entrega
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <!--[if BLOCK]><![endif]--><?php if($orden->status=="canceled"): ?>
                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <!--[if BLOCK]><![endif]--><?php if($orden->study_id): ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo e(($orden->type=="shipping") ? "Envío" : "Recogida"); ?></td>
                            </tr>
                ...
                <div class="col-md-12 pt-2">
                    <table class="table text-center" >
                        ...
                        <tbody>
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = json_decode($orden->creation_list); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$pd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                ...
                <!--[if BLOCK]><![endif]--><?php if($orden->status=="created"): ?>
                    <!--[if BLOCK]><![endif]--><?php if(!$preparando): ?>
                    <div class="col-md-12 pt-2">
                    ...
                    <div class="col-md-12 pt-2">
                        <table class="table text-center" >
                            ...
                            <tbody>
                                <!--[if BLOCK]><![endif]--><?php if(!empty($preparacion_list)): ?>
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $preparacion_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$prod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($index+1); ?></td>
                                    <td><?php echo e($prod["name"]); ?></td>
                                    <td><?php echo e($prod["amount"]); ?></td>
                                    <td>
                                        <!--[if BLOCK]><![endif]--><?php if($prod["use_firmware"]): ?>
                                        <input type="number" min="100000" max="999999" class="form-control" placeholder="Ejemplo: 1000000" wire:model="preparacion_list.<?php echo e($index); ?>.firmwareid">
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </td>
                                    <td><input class="form-check-input" type="checkbox" value="" wire:model="preparacion_list.<?php echo e($index); ?>.check"></td>
                                </tr>
                ...
                <div class="col-md-12 pt-2">
                    <table class="table text-center" >
                        ...
                        <tbody>
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = json_decode($orden->preparation_list); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$pd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($index+1); ?></td>
                                    <td><?php echo e($pd->name); ?></td>
                                    <td><?php echo e($pd->amount); ?></td>
                                    <td><?php echo e($pd->firmwareid??""); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                        </tbody>
                    </table>
                ...
                <!--[if BLOCK]><![endif]--><?php if($orden->status=="prepared"): ?>
                    <!--[if BLOCK]><![endif]--><?php if(!$enviando): ?>
                    <div class="col-md-12 pt-2">
                        <div class="text-center">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                <select class="form-select" wire:model="courier_enterprise">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $mensajerias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mensajeria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <!--[if BLOCK]><![endif]--><?php if(($orden->status=="prepared" || $orden->status=="created" || $orden->status=="waiting") && $orden->status!="canceled"): ?>
                <div class="col-md-12 pt-3">
                    <div class="text-center">
                ...
                <!--[if BLOCK]><![endif]--><?php if($orden->status=="collected"): ?>
                <div class="col-md-12 pt-2">
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                ...
                                <td><?php echo e($orden->received_date); ?></td>
                            </tr>

                            <tr>
                                <th scope="row">¿Quién recibió?</th>
                                <td><?php echo e($orden->receiver_info->name." (".$orden->receiver_info->id." - ".$orden->receiver_info->username.")"); ?></td>
                            </tr>

                            <tr>
                                <th scope="row">Comentarios</th>
                                <td><?php echo e($orden->received_notes); ?></td>
                            </tr>
                ...
                <!--[if BLOCK]><![endif]--><?php if(auth()->check() && auth()->user()->rank >= 4): ?>
                <!--[if BLOCK]><![endif]--><?php if($orden->finished): ?>
                <div class="col-md-12 pt-2">
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                ...
                                <td><?php echo e($orden->finished_date); ?></td>
                            </tr>

                            <tr>
                                <th scope="row">¿Quién la cerró?</th>
                                <td><?php echo e($orden->finisher_info->name." (".$orden->finisher_info->id." - ".$orden->finisher_info->username.")"); ?></td>
                            </tr>
                ...
                <!--[if BLOCK]><![endif]--><?php if($orden->status=="sended" && $orden->type=="collection"): ?>
                <div class="col-md-12 pt-3">
                    <div class="text-center">
                ...
                <!--[if BLOCK]><![endif]--><?php if((($orden->status=="sended" && $orden->type=="shipping") || ($orden->status=="collected" && $orden->type=="collection")) && !$orden->finished): ?>
                <div class="col-md-12 pt-3">
                    <div class="text-center">
