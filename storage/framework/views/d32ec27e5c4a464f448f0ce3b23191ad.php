...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['attributes' => $attributes,'size' => $size === 'sm' ? 'xs' : 'sm','xData' => '{ open: false }','xOn:click' => 'open = ! open; $el.closest(\'[data-flux-input]\').querySelector(\'input\').setAttribute(\'type\', open ? \'text\' : \'password\')','xBind:dataViewableOpen' => 'open','ariaLabel' => ''.e(__('Toggle password visibility')).'','xInit' => '
...
<?php endif; ?>
<?php $component->withAttributes(['attributes' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($attributes),'size' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($size === 'sm' ? 'xs' : 'sm'),'x-data' => '{ open: false }','x-on:click' => 'open = ! open; $el.closest(\'[data-flux-input]\').querySelector(\'input\').setAttribute(\'type\', open ? \'text\' : \'password\')','x-bind:data-viewable-open' => 'open','aria-label' => ''.e(__('Toggle password visibility')).'','x-init' => '
        let input = $el.closest(\'[data-flux-input]\')?.querySelector(\'input\');
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\RobboAdminPanel\panel\vendor\livewire\flux\stubs\resources\views\flux\input\viewable.blade.php ENDPATH**/ ?>