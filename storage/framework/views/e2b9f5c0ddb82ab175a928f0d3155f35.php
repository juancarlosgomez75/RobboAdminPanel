<div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-10 <?php if(!$filtrosActivos): ?> hide <?php endif; ?>" id="Filtros">
            <div class="row">
                <div class="col-md-3">
    ...
    <table class="table">
        ...
        <tbody class="align-center">
            ...
            <tr>
                ...
                <td>
                    <!--[if BLOCK]><![endif]--><?php if($producto->available): ?>
                ...
                <td>
                    <!--[if BLOCK]><![endif]--><?php if($producto->inventory->stock_available>=$producto->inventory->stock_min && $producto->inventory->stock_available!=0): ?>
...
<?php /**PATH C:\xampp\htdocs\RobboAdminPanel\panel\resources\views/livewire/inventario/productos.blade.php ENDPATH**/ ?>