<div>
    <!--[if BLOCK]><![endif]--><?php if($stock==0 && $activo): ?>
    <div class="alert alert-danger" role="alert">
        Este producto no tiene stock disponible
    </div>
    <?php elseif($stock>0 && $activo && $stock<$stockmin): ?>
    <div class="alert alert-warning" role="alert">
        El stock disponible de este producto está por debajo del stock recomendable
    </div>
    <?php elseif($stock>=$stockmin && $activo): ?>
                ...
                <div class="col-md-12 pt-3">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select" wire:model="firmware" <?php if(!$editing): ?> disabled <?php endif; ?>>
                ...
                <div class="col-md-12 pt-2">
                    <table class="table text-center" >
                        ...
                        <tbody class="align-center">
                            <!--[if BLOCK]><![endif]--><?php if(!$Movimientos->isempty()): ?>
                            ...
                            <tr>
                                ...
                                <td scope="row">
                                    <!--[if BLOCK]><![endif]--><?php if($movimiento->type=="expense"): ?>
                                ...
                                <td>
                                    <!--[if BLOCK]><![endif]--><?php if($movimiento->order_id): ?>
                                    <a href="<?php echo e(route("orden.ver",$movimiento->order_id)); ?>">O#<?php echo e($movimiento->order_id); ?></a>
                                    <?php elseif($movimiento->request_id): ?>
                                    <a href="<?php echo e(route("pedido.ver",$movimiento->request_id)); ?>">P#<?php echo e($movimiento->request_id); ?></a>
                                    <?php else: ?>
                                    No
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </td>
                                <td>
                                    <!--[if BLOCK]><![endif]--><?php if(!is_null($movimiento->details) && $movimiento->details!=""): ?>
                                    <?php echo e($movimiento->details); ?>
