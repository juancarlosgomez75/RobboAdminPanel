...
<div class="rounded-r bg-gray-900 xl:hidden flex justify-between w-full p-6 items-center ">
  ...
  <div id="Main" class="fixed xl:rounded-r transform  xl:translate-x-0  ease-in-out transition duration-500 flex justify-start items-start h-full  w-full sm:w-64 bg-gray-900 flex-col">
